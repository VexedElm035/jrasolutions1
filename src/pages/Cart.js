                ...
                <div className='mt-5 lg:mt-0 w-full max-w-sm'>
                        {
                            ...
                            <div className='h-36 bg-slate-200 border border-slate-300 animate-pulse'>
                                ...
                                <div className='h-36 bg-white'>
                                    <h2 className='text-white bg-blue-600 px-4 py-1'>Resumen</h2>
                                    ...
                                    <div className='mt-5 ml-6 w-full h-full'>

                                    <Link className='bg-blue-600 p-2 text-white w-full mt-2' to={"/pagado"}>Pagar</Link> 
                                    </div>
                                </div>
                            )
                        }
